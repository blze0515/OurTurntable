		...
		<div class="container">
			...
			<div class="row align-items-stretch">
				<div class="col-lg-4 order-lg-1">
					<div class="h-100"><div class="frame h-100"><div class="feature-img-bg h-100" style="background-image: url('${pageContext.request.contextPath }/images/hero-slider-1.jpg');"></div></div></div>
				</div>
		...
		<div class="container">
			<div class="row text-center">
				<div class="col-md-12">
					...
					<p class="mb-0"><a href="booking.jsp" class="btn btn-outline-white text-white btn-md font-weight-bold">Get in touch</a></p>
				</div>
			</div>
		</div>
	</div>
